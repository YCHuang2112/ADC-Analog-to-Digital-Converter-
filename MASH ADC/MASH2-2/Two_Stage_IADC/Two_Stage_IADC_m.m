...
open('Two_Stage_IADC.mdl'); sim('Two_Stage_IADC', t_sim, options); % 2015 Simulink
...
xlabel ('Amplitude (dBFS)'); ylabel ('SQNR (dB)'); axis([-90 0 0 150]);
legend('SQNR');
...
subplot(6,1,1), hist(int1q(:,index),hist_x); %plot(xx1, bin1);
grid on; title('INT1 histogram'); xlabel('Voltage [V]'); ylabel('Occurrences');xlim([-1*vref vref]);
subplot(6,1,2), hist(int2q(:,index),hist_x);
grid on; title('INT2 histogram'); xlabel('Voltage [V]'); ylabel('Occurrences');xlim([-1*vref vref]);
subplot(6,1,3), hist(adderq(:,index),hist_x);
grid on; title('ADDER histogram'); xlabel('Voltage [V]'); ylabel('Occurrences');xlim([-1*vref vref]);

subplot(6,1,4), hist(s2_int1q(:,index),hist_x); %plot(xx1, bin1);
grid on; title('S2_INT1 histogram'); xlabel('Voltage [V]'); ylabel('Occurrences');xlim([-1*vref vref]);
subplot(6,1,5), hist(s2_int2q(:,index),hist_x);
grid on; title('S2_INT2 histogram'); xlabel('Voltage [V]'); ylabel('Occurrences');xlim([-1*vref vref]);
subplot(6,1,6), hist(s2_adderq(:,index),hist_x);
grid on; title('S2_ADDER histogram'); xlabel('Voltage [V]'); ylabel('Occurrences');xlim([-1*vref vref]);
